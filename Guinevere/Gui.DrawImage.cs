...
public partial class Gui
{
    ...
    /// source and with a color tint and opacity. Only takes effect during the render pass.
    /// </summary>
    ...
    /// <param name="tint">Multiplied into the image's colors; <c>null</c> leaves them unchanged.</param>
    ...
    /// <param name="tint">Multiplied into the bitmap's colors; <c>null</c> leaves them unchanged.</param>
    /// <param name="opacity">Overall opacity in [0, 1].</param>
    [PublicAPI]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
